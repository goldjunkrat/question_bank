<template>
	<view class="container">
		...
		<SubmitAnswer v-show="!isSubmit&&isSingle" @tap="submitAnswerSingle" :noChoosenOption="noChoosenOption" />
...
<script>
	...
	import BottomNav from "../../components/question_answer/BottomNavigation.vue"
	import SubmitAnswer from "../../components/question_answer/SubmitAnswer.vue"
	import LastOrNext from "../../components/question_answer/LastOrNext.vue"
	...
	export default {
		...
		methods: {
			submitAnswerSingle() {
				...
				uni.request({
					url: `${this.$store.state.baseUrl}question/submitquestion`,
					method: 'POST',
					header: {
